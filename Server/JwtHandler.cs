...
namespace Server
{
    public class JwtHandler(IConfiguration configuration, UserManager<ClubPlayerUser> userManager)
    {
        public async Task<JwtSecurityToken> GetTokenAsync(ClubPlayerUser user) =>
        new(
        ...
        private async Task<List<Claim>> GetClaimsAsync(ClubPlayerUser user)
        {
